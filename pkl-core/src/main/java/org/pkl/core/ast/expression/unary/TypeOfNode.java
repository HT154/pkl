...
public final class TypeOfNode extends UnaryExpressionNode {
  ...
  public TypeOfNode(SourceSection sourceSection, UnresolvedTypeNode unresolvedTypeNode) {
    super(sourceSection);
  ...
  public Object executeGeneric(VirtualFrame frame) {
    ...
    return new VmType(typeNode, module.getVmClass());
  }
}
