...
:uri-stdlib-ReferencePropertyAccess: {uri-stdlib-baseModule}/ReferencePropertyAccess
:uri-stdlib-ReferenceSubscriptAccess: {uri-stdlib-baseModule}/ReferenceSubscriptAccess
